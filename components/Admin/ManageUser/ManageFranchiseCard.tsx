...
export function ManageFranchiseCard({ business }: BusinessCardProps) {
  const router = useRouter();

  const handleContactClick = () => {
    router.push({
      pathname: "/Admin/manage-users/manage-franchise",
    ...
    >
      ...
      >
        <p className="font-thin text-[14px] text-[#cccccc] text-justify">
          ...
          requiring ₹{business.InvestmentRangeEnd}. Established in{" "}
