...
const ManageFranchiseBusinessUser = () => {
  ...
  const handleEditProfile = () => {
    setModal({
      show: true,
      title: "Edit Profile",
      content: "Edit the profile information here.",
      isEditProfile: true,
    });
  };

  const handleRemovePremium = () => {
    // Implement the Remove Premium functionality
  };
...
export default ManageFranchiseBusinessUser;
