...
const navListMenuItems = [{ title: "Blog", path: "/Businesses/blog" }];

const navbarList = [
  { title: "Home", path: "homepage" },
  { title: "Investors", path: "search-for-investors" },
...
const profileMenuItems = [
  ...
  { label: "Help", icon: LifebuoyIcon, path: "contact-us" },
...
function NavListMenu() {
  ...
  const handleMenuItemClick = (menuItem: { title: string; path: Url }) => {
