...
const navListMenuItems = [
  {
    title: "Blog",
    path: "/Businesses/blog",
  },
];

const navbarList = [
  { id: 1, title: "Home", path: "homepage" },
  { id: 2, title: "Investors", path: "search-for-investors" },
  { id: 3, title: "Proposals", path: "proposals" },
  { id: 4, title: "Bookmarks", path: "bookmark" },
  { id: 5, title: "Q&A", path: "QandA" },
  {
    id: 6,
    title: "Company",
    path: "company",
