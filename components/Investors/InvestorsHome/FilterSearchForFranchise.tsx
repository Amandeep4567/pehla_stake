...
export function FilterSearchForFranchise({
  isFilterVisible,
  setIsFilterVisible,
  filters,
  setFilters,
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="rounded-full text-[#B8FF22] p-1"
            >
            ...
            {LegalEntity.map((entity) => (
              <label key={entity} className="flex items-center space-x-2 mb-2">
                <input
                  ...
                  className="checkbox_design"
                />
                <span className="text-green-200">{entity}</span>
              </label>
            ))}
          </div>

          <hr className="bg-[#00171A] dark:bg-gray-400" />
            ...
            <input
              ...
              className={`w-full p-2 rounded-lg ${
                theme === "dark"
                  ...
                  : "bg-gray-400 text-black placeholder-gray-500"
              ...
              <div className="mb-4">
                ...
                <div
                  className={`rounded-lg p-2 mt-2 ${
                    theme === "dark" ? "text-white bg-[#103B3E]" : "bg-gray-200"
                  }`}
                >
                  <label
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-4">
              <select
                ...
                className={`w-full p-2 rounded-lg border text-[14px] outline-none ${
                  theme === "dark"
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              className={`w-full font-medium rounded-full text-sm px-5 py-2 text-center ${
                theme === "dark"
                  ? "text-[#003034] bg-[#B8FF22]"
