...
const SearchForFranchise = () => {
  ...
  const filteredBusinesses = businessesData.filter((business) => {
    ...
    //   (filters.yearRange?.startYear === undefined ||
    //     business.establishmentYear >= filters.yearRange.startYear) &&
    //   (filters.yearRange?.endYear === undefined ||
    //     business.establishmentYear <= filters.yearRange.endYear);
          ...
          <div className="flex items-center flex-wrap mb-2">
            {!isFilterVisible &&
              (screenWidth > 768 ? (
                ...
                <SidebarFilterSearchForFranchise
                  isFilterVisible={isFilterVisible}
...
export default SearchForFranchise;
