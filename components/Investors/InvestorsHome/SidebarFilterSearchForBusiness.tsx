...
interface SidebarFilterSearchForBusinessProps {
...
export const SidebarFilterSearchForBusiness: React.FC<
  SidebarFilterSearchForBusinessProps
> = ({
  isFilterVisible,
  setIsFilterVisible,
  filters,
...
export default SidebarFilterSearchForBusiness;
